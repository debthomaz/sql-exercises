...
- Tente resolver o exercício antes de ver a minha solução, caso não saiba como começar ou trave em alguma parte, aí sim siga para a resolução.
- Nunca há apenas uma maneira de se construir um código, então não se prenda à minha solução, busque entender o raciocínio e desenvolver a resposta com o que sabe.
...
4. Você pode testar a minha solução também, executando o arquivo .sql do exercício no banco.

>Observação:

Caso o exercício seja de alguma plataforma de exercícios online, terá o link para o exercício e você poderá resolver dentro da plataforma, sem precisar de um banco de dados na sua máquina.
